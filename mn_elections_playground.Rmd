...
## Creating county commissioner district polygons
...
ggplot(comm_dists_19, aes(fill = ctycomdist)) + 
  ...
  labs(subtitle = "Only six counties have 7 county commissioner districts (7th dist. in yellow):\nAnoka, Dakota, Hennepin, Olmsted, Ramsey, and St. Louis") + 
...
plot_com_elections(2016, "general", "Hennepin")

side_by_side(2012, "Hennepin")

comm.elections.df(2016, "general") %>% filter(county_id == 27)

clean_county(2016, "general") %>% filter(county_id == 27)
