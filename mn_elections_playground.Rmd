...
ggplot(counties_demo_map_2010, aes(fill = (100 - perc_fem_18.24)/perc_fem_18.24)) + 
  geom_sf(color = "black", lwd = 0.25) + 
  theme_void() + scale_fill_gradient(low = "blue", high = "pink",
                                     position = "right", name = NULL,
                                     ) +
  labs(title = "Ratio of guys to girls, by county")
